...
class AppointmentService extends \MindbodyAPI\MindbodyClient {
	...
	public static $classmap = array(
		...
		'ApplyPayment' => 'MindbodyAPI\structures\ApplyPayment',
		'AppointmentApplyPaymentRequest' => 'MindbodyAPI\structures\AppointmentApplyPaymentRequest',
		'ApplyPaymentResponse' => 'MindbodyAPI\structures\ApplyPaymentResponse',
		'AppointmentApplyPaymentResult' => 'MindbodyAPI\structures\AppointmentApplyPaymentResult',
	);

	public function __construct($wsdl = "/0_5/AppointmentService.asmx?WSDL", $options = array()) {
		...
		if (!isset($options['location'])){
			$options['location'] = self::$server . '/0_5/AppointmentService.asmx';
		}
	 ...
	 */
	public function ApplyPayment(structures\ApplyPayment $parameters) {
		return $this->__soapCall('ApplyPayment', array($parameters), array(
					'uri' => 'http://clients.mindbodyonline.com/api/0_5',
					'soapaction' => ''
						)
		);
