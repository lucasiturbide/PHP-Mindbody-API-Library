...
class FinderService extends \MindbodyAPI\MindbodyClient {
	...
	public function __construct($wsdl = "/0_5/FinderService.asmx?WSDL", $options = array()) {
		...
		if (!isset($options['location'])) $options['location'] = self::$server . '/0_5/FinderService.asmx';
